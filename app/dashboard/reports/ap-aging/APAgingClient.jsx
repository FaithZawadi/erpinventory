...
export function APAgingClient({ initialData, initialAsOfDate, error }) {
  ...
  const handleDateChange = () => {
    startTransition(() => {
      router.push(`/dashboard/reports/ap-aging?asOf=${asOfDate}`);
    });
  };
  ...
  const handleExportCSV = () => {
    ...
    const rows = data.suppliers.map((s) => [
      s.supplierName,
      s.current.toFixed(2),
      s.days1_30.toFixed(2),
      s.days31_60.toFixed(2),
      s.days61_90.toFixed(2),
  ...
  return (
    <div className="container mx-auto px-3 sm:px-4 py-4 sm:py-6 max-w-7xl print:p-0">
      ...
      <div className="hidden print:block mb-6">
        <h1 className="text-2xl font-bold text-center">AP Aging Report</h1>
      ...
      <div className="grid gap-2 sm:gap-4 grid-cols-2 lg:grid-cols-4 mb-4 sm:mb-6 print:grid-cols-4">
        <Card className="p-3 sm:p-0">
          ...
          <CardContent className="p-0 sm:p-4 sm:pt-0 mt-1 sm:mt-0">
            ...
            <p className="text-[10px] sm:text-xs text-muted-foreground">
              {data?.summary?.billCount || 0} bills
            </p>
          </CardContent>
        </Card>
        ...
        <Card className="p-3 sm:p-0">
          <CardHeader className="p-0 sm:p-4 sm:pb-2 flex flex-row items-center justify-between space-y-0">
            ...
            <Building2 className="h-3.5 w-3.5 sm:h-4 sm:w-4 text-muted-foreground hidden sm:block" />
          </CardHeader>
          <CardContent className="p-0 sm:p-4 sm:pt-0 mt-1 sm:mt-0">
            <div className="text-base sm:text-xl lg:text-2xl font-bold text-foreground">
                      ...
                      >
                        ...
                        <td className="p-4 text-right">
                          <span className="text-sm tabular-nums text-yellow-600">
                            {supplier.days1_30 > 0
                              ? formatCurrency(supplier.days1_30)
                              : "-"}
                          </span>
                        </td>
                        <td className="p-4 text-right">
